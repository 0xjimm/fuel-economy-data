...
format files are named ??GUIDE6.XLSclass     - vehicle class name
...
cls          vehicle class code(1=2seater, 2=minicompact, etc) (for 2000 or later only)
...
col 148, in I5
     ...
     1      26     BODY TYPE 2D    191      10    A      0     BODY TYPE 2 DOOR - IF THE BODYTYPE APPLIES IT WILL TAKE THE
                                                               FORM '2DR-PPP/LL' WHERE PPP=PASSENGER
INTERIOR VOLUME AND
                                                               LL=LUGGAGE INTERIOR VOLUME.
...
TO A CARLINE.  INFORMATION
                                                               RELATING TO A CARLINE CODE CAN BEOBTAINED FROM CARLINE DATA FILE.
...
1 & 17=LEADED GASOLINE,
     ...
     1      30     SALES-MTOTC      95       6    I      0     MODEL SALES EXCLUDING THOSEWITH SUPPRESSION CODE 2 OR 9
                                                               ERASED/BLANKED IF FOR PUBLIC ACCESS
